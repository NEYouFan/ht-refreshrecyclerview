...
import com.netease.demo.refreshstyle.DotStyleHorizontalRightRefreshViewHolder;
...
public class HorizontalRightRefreshActivity extends AppCompatActivity implements HTLoadMoreListener, HTRefreshListener, View.OnClickListener {
...
//        HTRefreshRecyclerView.setRefreshViewHolderClass(DotStyleVerticalDownRefreshViewHolder.class);
        Intent intent = new Intent(context, HorizontalRightRefreshActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horizontal_right);
        initView();
    }
    ...
    public void initView() {
        ...
        MyAdapter myAdapter = new MyAdapter(mData, 0);
        mRefreshLayout = (HTRefreshRecyclerView) findViewById(R.id.horizontal_refresh);
        //设置刷新样式的视图,HTBaseViewHolder,具体可查看demo中DotStyleRefreshViewHolder实现
        HTBaseViewHolder viewHolder=new DotStyleHorizontalRightRefreshViewHolder(this);
...
//        layoutManager = new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL);//设置瀑布流布局方式
        ...
        mRefreshLayout.addItemDecoration(new DividerItemDecoration(DividerItemDecoration.HORIZONTAL));
        ...
        if (mData.size() > 20) {
            ...
            new Handler(getMainLooper()).postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(HorizontalRightRefreshActivity.this, "loadMore Completed", Toast.LENGTH_SHORT).show();
    ...
    public void onRefresh() {
        ...
        new Handler(getMainLooper()).postDelayed(new Runnable() {
            public void run() {
                ...
                mRefreshLayout.getAdapter().notifyDataSetChanged();
                mRefreshLayout.setRefreshCompleted(true);
                Toast.makeText(HorizontalRightRefreshActivity.this, "refresh Completed", Toast.LENGTH_SHORT).show();
            }
...
//                mRefreshLayout.getAdapter().notifyItemRemoved(0);
//                mData.remove(0);
                break;
            }
