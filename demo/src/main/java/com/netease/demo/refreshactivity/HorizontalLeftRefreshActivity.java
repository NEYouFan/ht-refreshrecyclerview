...
import com.netease.demo.refreshstyle.DotStyleHorizontalLeftRefreshViewHolder;
...
public class HorizontalLeftRefreshActivity extends AppCompatActivity implements HTLoadMoreListener, HTRefreshListener, View.OnClickListener {
...
//        HTRefreshRecyclerView.setRefreshViewHolderClass(DotStyleVerticalDownRefreshViewHolder.class);
        Intent intent = new Intent(context, HorizontalLeftRefreshActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horizontal_left);
        initView();
    }
        ...
        if (mData.size() > 20) {
            ...
            new Handler(getMainLooper()).postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(HorizontalLeftRefreshActivity.this, "loadMore Completed", Toast.LENGTH_SHORT).show();
    ...
    public void onRefresh() {
        new Handler(getMainLooper()).postDelayed(new Runnable() {
            public void run() {
                ...
                mRefreshLayout.getAdapter().notifyDataSetChanged();
                mRefreshLayout.setRefreshCompleted(true);
                Toast.makeText(HorizontalLeftRefreshActivity.this, "refresh Completed", Toast.LENGTH_SHORT).show();
            }
        }, 2000);
    }
