 ...
 */
public class DotStyleVerticalUpRefreshViewHolder extends HTBaseViewHolder {
    ...
    public DotStyleVerticalUpRefreshViewHolder(Context context) {
        super(context);
...
//        setAnimationTime(5000);
    ...
    public void onRefreshPositionChange(float scale, float moveYDistance) {
        float diffY = moveYDistance - mRefreshLoadView.getY() - mRefreshLoadView.getMeasuredHeight();
        if (diffY > 0) {
