 ...
 */
public class DotStyleHorizontalLeftRefreshViewHolder extends HTBaseViewHolder {
    ...
    public DotStyleHorizontalLeftRefreshViewHolder(Context context) {
        super(context);
...
//        setAnimationTime(5000);
    ...
    public View onInitRefreshView(ViewGroup parent) {
        View refreshView = View.inflate(mContext, R.layout.horizontal_refresh_view, parent);
    ...
    public View onInitLoadMoreView(ViewGroup parent) {
        View loadMoreView = View.inflate(mContext, R.layout.horizontal_load_more_view, parent);
    ...
    public void onRefreshPositionChange(float scale, float moveXDistance, int refreshStatus, HTViewHolderTracker viewHolderTracker) {
        ...
        float diffX = moveXDistance - mRefreshLoadView.getX() - mRefreshLoadView.getMeasuredWidth();
        if (diffX > 0) {
